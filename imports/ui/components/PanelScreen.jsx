...
export class PanelScreen extends Component {
...
//        console.log('PaneMain:render:return()');
    ...
    */
    ...
    componentDidMount() {
//        console.log("PanelScreen:componentDidMount");
    ...
    componentDidUpdate() {
//        console.log("PanelScreen:componentDidUpdate");
        this.updateDisplay();
...
export default PanelScreen = createContainer(() => {
//    console.log("PanelScreen:createContainer");
    
    Meteor.user();  // This is required in the createContainer(). Unless this, this program does not react, componentDidUpdate() is not triggered.
